...
return [
    ...
    'account' => [
        ...
        'remember_me' => 'Ostani ulogovan',
        'forgot_password' => 'Zaboravljena lozinka?',
        'enter_email' => 'Unesi svoj email',
        'enter_login' => 'Unesi svoj login',
    ...
    'access_log' => [
        'hint' => 'Ovaj log prikazuje listu uspešnih logova od strane administratora. Logovi se čuvaju ukupno :days dana.',
        'menu_label' => 'Logovi pristupa',
        'menu_description' => 'Prikaži listu uspešnih logovanja na pozadinski sistem.',
        'id' => 'ID',
    ...
    'import_export' => [
        'upload_csv_file' => '1. Otpremi CSV fajl',
        'import_file' => 'Uvezi fajl',
        'row' => 'Red :row',
        'first_row_contains_titles' => 'Prvi red sadrži naslove kolona',
        'first_row_contains_titles_desc' => 'Ostavite ovo polje označeno ako se prvi red u CSV fajlu koristi za naslove kolona.',
        'match_columns' => '2. Upari kolone fajla sa kolonama baze podataka',
        'file_columns' => 'Kolone fajla',
        'database_fields' => 'Polja u bazi podataka',
        'set_import_options' => '3. Postavi uvozne opcije',
        'export_output_format' => '1. Izvezi izlazni format',
        'file_format' => 'Format fajla',
        'standard_format' => 'Standardni format',
        'custom_format' => 'Proizvoljni format',
        'delimiter_char' => 'Granični znak',
        'enclosure_char' => 'Ogradni znak',
        'escape_char' => 'Komandni znak',
        'select_columns' => '2. Izaberi kolone za izvoz',
        'column' => 'Kolona',
        'columns' => 'Kolone',
        'set_export_options' => '3. Postavi izvozne opcije',
        ...
        'export_progress' => 'Progres izvoza',
        'export_error' => 'Greška pri izvozu',
        'column_preview' => 'Pregled kolone',
        ...
        'encoding_format' => 'Format enkodovanja',
        'encodings' => [
            'utf_8' => 'UTF-8',
            'us_ascii' => 'US-ASCII',
