...
return [
    ...
    */
    ...
    'ends_with' => ':attribute بایستی با یکی از مقادیر  :values تمام شود.',
    'exists' => ':attribute انتخاب شده نامعتبر است.',
    'file' => ':attribute باید یک فایل باشد.',
    'filled' => 'مقداری برای :attribute وارد نشده است.',
    'gt' => [
        'numeric' => 'مقدار :attribute بایستی بزرگتر از  :value باشد.',
        'file' => 'مقدار :attribute بایستی بیشتر از  :value کیلوبایت باشد.',
        'string' => 'مقدار :attribute بایستی بیشتر از  :value حرف باشد.',
        'array' => 'مقدار :attribute بایستی بیشتر از  :value مورد باشد.',
    ],
    'gte' => [
        'numeric' => 'مقدار :attribute بایستی بزرگتر مساوی  :value باشد.',
        'file' => 'مقدار :attribute بایستی بزرگتر مساوی :value کیلوبایت باشد.',
        'string' => 'مقدار :attribute بایستی بزرگتر مساوی :value حرف یاشد.',
    ...
    'lt' => [
        ...
        'array' => ':attribute بایستی کمتر از :value مورد باشد.',
    ],
    'lte' => [
        'numeric' => ':attribute must بایستی کمتر و یا مساوی  :value باشد.',
        'file' => ':attribute must بایستی کمتر و یا مساوی  :value کیلوبایت باشد.',
        'string' => ':attribute must بایستی کمتر و یا مساوی  :value حرف باشد.',
        'array' => ':attribute نباید بیشتر از  :value موردباشد.',
    ],
    'max' => [
    ...
    'starts_with' => ':attribute بایستی با یکی از مقادیر  :values شروع شود.',
