...
return [
    ...
    'theme' => [
        ...
        'name' => [
            'label' => 'Όνομα Θέματος',
            'help' => 'Ονομάστε το θέμα με τον μοναδικό κωδικό του. Για παράδειγμα, Winter.Vanilla',
        ],
    ],
    'themes' => [
    ...
    'plugin' => [
        ...
        'name' => [
            ...
            'help' => 'Ονομάστε το πρόσθετο με τον μοναδικό κωδικό του. Για παράδειγμα Winter.Blog',
        ],
    ],
    'plugins' => [
