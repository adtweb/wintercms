...
class SourceManifest
{
     ...
     *
     * @param  string|int  $build  Build version to get the filelist state for.
     *
     ...
     * @param  FileManifest|string|int  $previous  Either a previous manifest, or the previous build number as an int
